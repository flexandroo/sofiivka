(function () {
  ...
  function footerExtended() {
    return `<footer class="footer"><div class="container footer__top"><a class="brand brand--footer" href="/index.html"><img src="/assets/logo-sofievka-transparent.png" width="1942" height="809" alt="Софіївка"></a><div class="footer__meta"><p>Обладнання для опалення, водопостачання, сантехніки та клімату.</p><div class="footer__socials" aria-hidden="true"><span class="footer__social" title="Instagram"><svg viewBox="0 0 24 24"><rect x="3.5" y="3.5" width="17" height="17" rx="4"></rect><circle cx="12" cy="12" r="4"></circle><circle cx="17.5" cy="6.5" r="1"></circle></svg></span><span class="footer__social" title="Facebook"><svg viewBox="0 0 24 24"><path d="M14.5 8H17V4.5h-2.5C11.7 4.5 10 6.2 10 9v2H7v3.5h3V21h4v-6.5h3L17.5 11H14V9c0-.7.3-1 1-1Z"></path></svg></span><span class="footer__social" title="YouTube"><svg viewBox="0 0 24 24"><path d="M20.2 7.1c-.2-.9-.9-1.6-1.8-1.8C16.8 5 12 5 12 5s-4.8 0-6.4.3c-.9.2-1.6.9-1.8 1.8C3.5 8.7 3.5 12 3.5 12s0 3.3.3 4.9c.2.9.9 1.6 1.8 1.8 1.6.3 6.4.3 6.4.3s4.8 0 6.4-.3c.9-.2 1.6-.9 1.8-1.8.3-1.6.3-4.9.3-4.9s0-3.3-.3-4.9Z"></path><path class="footer__social-play" d="m10 15.5 5-3.5-5-3.5v7Z"></path></svg></span></div></div></div><div class="container footer__grid"><nav aria-label="Каталог у підвалі"><h2>Каталог</h2><a href="/catalog/heating">Опалення</a><a href="/catalog/water-supply">Водопостачання</a><a href="/catalog/plumbing">Сантехніка</a><a href="/catalog/climate">Клімат</a></nav><nav aria-label="Послуги у підвалі"><h2>Послуги</h2><a href="/installation.html">Монтаж</a><a href="/service-center.html">Сервісний центр</a><a href="/solutions.html">Комплексні рішення</a><a href="/partnership.html">Для монтажників</a></nav><nav aria-label="Покупцям у підвалі"><h2>Покупцям</h2><a href="/delivery.html">Доставка</a><a href="/payment.html">Оплата</a><a href="/warranty.html">Гарантія</a><a href="/returns.html">Обмін і повернення</a></nav><div class="footer__contacts"><h2>Компанія</h2><a href="/about.html">Про нас</a><a href="/brands">Бренди</a><a href="/contact.html">Контакти та графік</a><p><a href="/partnership.html">Надіслати специфікацію</a><br><a href="/faq.html">Часті запитання</a></p></div></div><div class="container footer__bottom"><span>© 2026 Торговий дім «Софіївка»</span><span><a href="/privacy.html">Конфіденційність</a> · <a href="/terms.html">Умови</a></span></div></footer>`;
  }
